...
PJA_SMOKE_MILESTONE=2.2.0 PJA_APP_VERSION=2.2.0 scripts/docker-smoke-v2.sh
...
Do not restore public Jobs, Job Rankings, Approvals, Tasks, or the historical Application pipeline. Their models and migrations remain for compatibility, but the full application must return 410 for retired APIs. Version 2.2.0 exposes only Application list/detail/delete and manual/Analysis submission creation. Analyze remains independent of retired Job and workflow entities.
