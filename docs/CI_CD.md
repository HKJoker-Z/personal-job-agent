...
and records OCI source, full revision, and Version `2.0.6`. When annotated tag
`v2.0.6` is later pushed after production GO, the tag-triggered path validates
