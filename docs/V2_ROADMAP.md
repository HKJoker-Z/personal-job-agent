...
## Current release candidate: 2.0.7

Version 2.0.7 is the prepared release candidate; public production remains
Version 2.0.6 until deployment. It retains the private, stateless Java
normalization-only integration and bounded synchronous Analyze behavior, and
fixes History View so saved analysis details use the shared Analyze result
renderer without a new analysis request. The schema remains `20260730_07`.
...
scope is defined by the Version 2.0.1 through 2.0.7 release notes plus the
...
2.0.7 does not include automatic application submission, a browser extension,
