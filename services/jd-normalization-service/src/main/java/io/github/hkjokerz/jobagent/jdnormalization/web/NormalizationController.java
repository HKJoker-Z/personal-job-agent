...
public class NormalizationController {
    ...
    public void rejectNormalizeGet() throws HttpRequestMethodNotSupportedException {
        throw new HttpRequestMethodNotSupportedException("GET", java.util.Set.of("POST"));
    }
}
