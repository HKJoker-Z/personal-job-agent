...
export function FeatureRemovedPage() {
  return <section className="panel state-panel feature-state" aria-labelledby="feature-removed-title">
    <span className="eyebrow">Version 2.2.0</span>
    <h1 id="feature-removed-title">Feature removed</h1>
    <p>This workspace no longer provides Jobs, Job Rankings, Approvals, or Tasks. Historical database records were preserved for rollback and recovery.</p>
